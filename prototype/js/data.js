/* ============================================================
   DEMO DATA — every person, event and number here is invented.
   Nothing in this file describes a real client or employee.
   ============================================================ */
...
var DATA = (function () {
  ...
  return {
    AGENCIES: AGENCIES, USERS: USERS, ROLE_LABEL: ROLE_LABEL,
