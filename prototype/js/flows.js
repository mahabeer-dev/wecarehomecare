...
FLOWS['maria'] = {
  ...
  steps: [
    ...
    { screen: 'clients.profile',   label: 'Look at her waiver documents' },
    { screen: 'clients.checklist', label: 'Open her authorisation' },
    ...
    { screen: 'inc.aged',          label: '12 April — she goes to hospital' },
    ...
    { screen: 'qi.detail',         label: 'May — her ISP progress drops' },
...
FLOWS['hospital'] = {
  ...
  steps: [
    ...
    { screen: 'dash.home',   label: 'Her list for today', role: 'nurse' },
    { screen: 'hosp.visit',  label: 'She finds a new medication' },
